											...
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="invoice-table">
													<div class="table-responsive">
														<table class="table table-striped table-bordered">
															...
															<%}else{
																	for(int i=0; i<vlist.size();i++){
																		...
																		LclBean lbean = lcl.getLcl(vlist.get(i).getNo());
															%>
															<tbody>
																<tr>
																	<td><%=quotation.getNo()%></td>
																	<td><%=lbean.getItem()%></td>
																	<td><%=lbean.getDeparture()%></td>
																	<td><%=lbean.getArrive() %></td>
																	<td><%=lbean.getIncoterms()%></td>
																	...
																	<td>
																		<button name = "detail" method="post" class="btn theme-btn"
																			onclick="location.href='lclReplyRead.jsp?no=<%=quotation.getNo()%>';">detail
																		</button>
																	</td>
																</tr>
															</tbody>
														...
														<form name = "detail" method="post" action="../quote/boardLclRead.jsp">
